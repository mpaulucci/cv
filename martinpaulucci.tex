...
\cventry{October 2011 - February 2012}{Web Developer (Django)}{Freelance}{Buenos Aires}{Argentina}{Development, bug fixing, performance improvements and deployment of a construction management application, using Python, Django, PostgreSQL, JQuery, Mercurial, nginx.}
